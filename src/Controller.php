...
use Jevo\JDirectory\Filters;
use Jevo\JDirectory\JDirectory;
...
class Controller
{
    ...
    public function setLimit(Request $request, SiteContent $container, JDirectory $directory)
    {
    ...
    public function action(Request $request, JDirectory $directory)
    {
